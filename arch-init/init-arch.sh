...
try_install_pacman_package "jq"
try_install_pacman_package "webkit2gtk"
try_install_pacman_package "firefox"
try_install_pacman_package "pigz"
try_install_pacman_package "jdk21-openjdk"
try_install_pacman_package "fuse2"
