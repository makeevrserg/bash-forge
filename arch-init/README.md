...
# Add this
# i915.enable_guc=3 elevator=bfq nvme_core.default_ps_max_latency_us=5500 pcie_aspm=off intel_idle.max_cstate=1 i915.enable_fbc=0 intel_pstate=active i915.enable_psr=0 i915.enable_dc=0 ahci.mobile_lpm_policy=1
